...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo"><span class="w3-hide-small">I'm</span> RAJEEV KR.</h1>
    <p>Photographer and Web Designer.</p>
    <img src="https://images.app.goo.gl/yGvpAnPp7eZAcM7c9" alt="boy" class="w3-image" width="992" height="1108">
  </header>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    ...
    <p>I’m Rajeev Kumar, a passionate and ambitious front-end developer and content writer currently pursuing my B.Tech in Electronics and Communication Engineering (2024–2028). As a fresher, I am driven by a strong desire to learn, grow, and become the best in my field of work. I believe in combining creativity with technical precision to build meaningful digital experiences and impactful content.
    ...
    <p><span class="w3-large w3-margin-right">ac.</span> CEO at Mighty Schools.</p>
    <p>Rajeev saved us from a web disaster.</p><br>
    ...
    <p><span class="w3-large w3-margin-right">childd eler.</span> CEO at Company.</p>
    <p>No one is better than Rajeev.</p>
  <!-- End About Section -->
  </div>
